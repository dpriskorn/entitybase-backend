...
from models.watchlist import WatchlistAddRequest, WatchlistRemoveRequest, MarkCheckedRequest
...
class TestWatchlistHandler:
    ...
    def test_add_watch_success(self):
        ...
        vitess_client.watchlist_repository.add_watch.assert_called_once_with(123, "Q42", ["P31"])
    ...
    def test_remove_watch_success(self):
        ...
        handler = WatchlistHandler()
        request = WatchlistRemoveRequest(user_id=123, entity_id="Q42", properties=["P31"])
        result = handler.remove_watch(request, vitess_client)

        assert result.message == "Watch removed"
        vitess_client.watchlist_repository.remove_watch.assert_called_once_with(123, "Q42", ["P31"])
    ...
    def test_get_watches_success(self):
        ...
        vitess_client.user_repository.user_exists.return_value = True
        vitess_client.user_repository.is_watchlist_enabled.return_value = True
        vitess_client.watchlist_repository.get_watches_for_user.return_value = [{"entity_id": "Q42", "properties": ["P31"]}]
        ...
        vitess_client.watchlist_repository.get_watches_for_user.assert_called_once_with(123)
        vitess_client.user_repository.update_user_activity.assert_called_once_with(123)
    ...
    def test_get_notifications_success(self):
        ...
        vitess_client.watchlist_repository.get_user_notifications.assert_called_once_with(123, 24, 50, 0)
    ...
    def test_mark_checked_success(self):
        ...
        vitess_client.watchlist_repository.mark_notification_checked.assert_called_once_with(456, 123)
