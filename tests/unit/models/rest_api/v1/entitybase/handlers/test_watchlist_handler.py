...
class TestWatchlistHandler:
    ...
    def test_add_watch_user_not_exists(self) -> None:
    ...
    def test_add_watch_disabled(self) -> None:
    ...
    def test_get_watches_success(self) -> None:
    ...
    def test_get_notifications_success(self) -> None:
    ...
    def test_mark_checked_success(self) -> None:
    ...
    def test_get_watch_counts_success(self) -> None:
