...
class TestBacklinkPopulation:
    ...
    @patch(
        "models.rest_api.entitybase.v1.services.statement_service.hash_entity_statements"
    )
    @patch(
        "models.rest_api.entitybase.v1.services.statement_service.deduplicate_and_store_statements"
    )
