...
from models.s3_models import LabelsHashes, DescriptionsHashes, AliasesHashes, SitelinksHashes, StatementsHashes, HashMaps
...
class TestHashService(unittest.TestCase):
    ...
    @patch('models.rest_api.entitybase.services.hash_service.deduplicate_and_store_statements')
    def test_hash_statements_success(self, mock_store, mock_hash):
        ...
        mock_hash_result = StatementHashResult(
            ...
            full_statements=[{"mainsnak": {"property": "P1"}}, {"mainsnak": {"property": "P2"}}]
        )
        ...
        result = HashService.hash_statements(entity_data, self.mock_vitess, self.mock_s3, self.mock_validator)
    ...
    def test_hash_statements_store_failure(self, mock_hash, mock_store):
        ...
        mock_hash_result = StatementHashResult(statements=[123], properties=[], property_counts={}, full_statements=[])
        mock_hash.return_value = MagicMock(success=True, data=mock_hash_result)
    ...
    @patch('models.rest_api.entitybase.services.hash_service.MetadataExtractor.hash_string')
    @patch('models.rest_api.entitybase.services.hash_service.MyS3Client.store_sitelink_metadata')
    ...
    @patch('models.rest_api.entitybase.services.hash_service.MyS3Client.store_term_metadata')
    ...
    def test_hash_descriptions(self, mock_store, mock_repo_class, mock_hash):
        ...
        result = HashService.hash_descriptions(descriptions, self.mock_s3, self.mock_vitess)
    ...
    def test_hash_entity_metadata(self, mock_aliases, mock_desc, mock_labels, mock_sitelinks, mock_statements):
        ...
        result = HashService.hash_entity_metadata(entity_data, self.mock_vitess, self.mock_s3, self.mock_validator)
        ...
        mock_statements.assert_called_once_with(entity_data, self.mock_vitess, self.mock_s3, self.mock_validator)
