...
class TestHashService(unittest.TestCase):
    ...
    @patch("models.rest_api.entitybase.v1.services.hash_service.hash_entity_statements")
    @patch(
        "models.rest_api.entitybase.v1.services.hash_service.deduplicate_and_store_statements"
    )
    ...
    @patch(
        "models.rest_api.entitybase.v1.services.hash_service.MetadataExtractor.hash_string"
    )
    @patch(
        "models.rest_api.entitybase.v1.services.hash_service.MyS3Client.store_sitelink_metadata"
    )
    ...
    @patch("models.rest_api.entitybase.v1.services.hash_service.TermsRepository")
    @patch(
        "models.rest_api.entitybase.v1.services.hash_service.MyS3Client.store_term_metadata"
    )
