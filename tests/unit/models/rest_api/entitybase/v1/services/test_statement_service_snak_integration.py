...
class TestStatementServiceSnakIntegration:
    ...
    def test_deduplicate_statements_handles_missing_mainsnak(self, mock_state):
        ...
        hash_result = StatementHashResult(
            statements=[123456792], properties=[], full_statements=[statement_data]
        )

        service = StatementService(state=mock_state)
        mock_state.s3_client.read_statement.side_effect = Exception("Not found")
        mock_state.mysql_client.insert_statement_content.return_value = True
