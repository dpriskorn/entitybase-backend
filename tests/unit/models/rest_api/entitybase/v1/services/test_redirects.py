...
class TestRedirectService:
    ...
    def test_validate_redirect_already_exists(self, service, mock_state):
        ...
        mock_state.db_client.get_redirect_target.return_value = "Q2"
    ...
    def test_validate_source_deleted(self, service, mock_state):
        ...
        mock_state.db_client.get_redirect_target.return_value = None
    ...
    def test_validate_target_deleted(self, service, mock_state):
        ...
        mock_state.db_client.get_redirect_target.return_value = None
        mock_state.db_client.is_entity_deleted.side_effect = [False, True]
        mock_request = EntityRedirectRequest(redirect_from_id="Q1", redirect_to_id="Q2")
    ...
    def test_validate_target_archived(self, service, mock_state):
        ...
        mock_state.db_client.get_redirect_target.return_value = None
        mock_state.db_client.is_entity_deleted.return_value = False
        mock_state.db_client.is_entity_locked.return_value = False
        mock_state.db_client.is_entity_archived.return_value = True
        mock_request = EntityRedirectRequest(redirect_from_id="Q1", redirect_to_id="Q2")
