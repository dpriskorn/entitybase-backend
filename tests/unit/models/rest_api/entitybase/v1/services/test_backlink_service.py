...
class TestBacklinkService:
    ...
    def test_extract_backlinks_from_entity(self):
        ...
        mock_state.db_client.id_resolver = mock_id_resolver
        mock_state.db_client.backlink_repository = MagicMock()
    ...
    def test_extract_backlinks_empty_claims(self):
        ...
        mock_state = MagicMock()
        mock_state.db_client.id_resolver = MagicMock()
        mock_state.db_client.backlink_repository = MagicMock()
    ...
    def test_extract_and_store_backlinks_success(self):
        ...
        mock_state.db_client.backlink_repository = mock_repo
