...
class TestEntityTTLRevisionEndpoint:
    ...
    async def test_get_entity_ttl_revision_success(self, mock_entity_read_state):
        ...
        mock_revision_data = S3RevisionData(
            schema="1.0.0",
            revision={"id": "Q123", "labels": {"en": {"language": "en", "value": "Test"}}},
            hash=123456,
    ...
    @pytest.mark.asyncio
    async def test_get_entity_ttl_revision_different_formats(self, mock_entity_read_state):
...
class TestEntityJsonRevisionEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_entity_json_revision_with_complex_data(self, mock_entity_read_state):
