...
class TestEndorsementHandler:
    ...
    def mock_vitess_client(self):
        ...
        mock_client.endorsement_repository.get_statement_endorsements.return_value = Mock(
            success=True,
            data={
    ...
    def test_endorse_statement_repository_error(self, handler, mock_vitess_client):
        ...
        mock_vitess_client.endorsement_repository.create_endorsement.return_value = Mock(
    ...
    def test_withdraw_endorsement_repository_error(self, handler, mock_vitess_client):
        ...
        mock_vitess_client.endorsement_repository.withdraw_endorsement.return_value = Mock(
            success=False, error="No active endorsement"
        )
    ...
    def test_get_statement_endorsements_repository_error(self, handler, mock_vitess_client):
    ...
    def test_get_batch_statement_endorsement_stats_success(self, handler, mock_vitess_client):
        """Test successful batch statement endorsement stats."""
        result = handler.get_batch_statement_endorsement_stats([456789], mock_vitess_client)
    ...
    def test_get_batch_statement_endorsement_stats_invalid_hash(self, handler, mock_vitess_client):
        """Test batch stats with invalid statement hash."""
        with pytest.raises(Exception):  # Should raise validation error
            handler.get_batch_statement_endorsement_stats([0], mock_vitess_client)

    def test_get_batch_statement_endorsement_stats_repository_error(self, handler, mock_vitess_client):
