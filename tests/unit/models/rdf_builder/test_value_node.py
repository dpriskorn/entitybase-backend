...
class TestGenerateValueNodeUri:
    def test_generate_value_node_uri_string(self) -> None:
        """Test URI generation for string value."""
        result = generate_value_node_uri("test")
        assert len(result) == 32  # MD5 hash length
        assert result.isalnum()

    def test_generate_value_node_uri_number(self) -> None:
        """Test URI generation for numeric value."""
        result = generate_value_node_uri(123)
        assert len(result) == 32
        assert result.isalnum()

    def test_generate_value_node_uri_different_values(self) -> None:
...
class TestSerializeValue:
    ...
    def test_serialize_value_number(self) -> None:
    ...
    def test_serialize_value_quantity_with_bounds(self) -> None:
    ...
    def test_serialize_value_globe(self) -> None:
    ...
    def test_serialize_value_no_kind(self) -> None:
