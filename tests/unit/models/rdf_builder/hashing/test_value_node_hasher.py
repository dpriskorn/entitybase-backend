...
class TestValueNodeHasher:
    ...
    def test_hash_quantity_value_basic(self):
    ...
    def test_hash_quantity_value_with_bounds(self):
    ...
    def test_hash_quantity_value_partial_bounds(self):
    ...
    def test_hash_entity_value(self):
    ...
    def test_hash_time_value_different_inputs(self):
    ...
    def test_hash_quantity_value_different_inputs(self):
