...
class TestParseProperty:
    def test_parse_property_valid(self):
    ...
    def test_parse_property_different_datatype(self):
    ...
    def test_parse_property_invalid_datatype(self):
    ...
    def test_parse_property_missing_id(self):
        """Test parsing property missing id field."""
        entity_json = {"datatype": "wikibase-item"}
        with pytest.raises(KeyError):
            parse_property(entity_json)

    def test_parse_property_missing_datatype(self):
