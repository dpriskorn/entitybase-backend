...
class TestS3ClientRevisions:
    ...
    def test_read_revision_with_content_hash(self):
        ...
        with patch(
            ...
            client = MyS3Client(config=config, db_client=mock_db_client)
    ...
    def test_read_revision_db_client_none(self):
        """Test read_revision raises 503 when db_client is None."""
        config = S3Config(
            endpoint_url="http://localhost:4566",
            access_key="test",
            secret_key="test",
        ...
        with patch(
            ...
            client = MyS3Client(config=config, db_client=None)
