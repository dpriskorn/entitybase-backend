...
Integration tests in tests/integration/models/infrastructure/mysql/test_mysql_client.py
...
class TestMysqlClient:
    ...
    def setup_mock_connection_manager(self, mock_mysql_connection_manager):
        """Apply the mock connection manager to all tests."""
        self.mock_connection, self.mock_cursor = mock_mysql_connection_manager
    ...
    def setup_method(self):
        ...
        self.client = MysqlClient(config=self.config)
    ...
    def test_cursor_property_returns_cursor_context_manager(self):
        ...
        from models.infrastructure.mysql.connection import CursorContextManager
    ...
    def test_entity_repository_property(self):
        ...
        from models.infrastructure.mysql.repositories.entity import EntityRepository

        result = self.client.entity_repository

        assert isinstance(result, EntityRepository)
        assert result.mysql_client == self.client
    ...
    def test_thanks_repository_property(self):
        ...
        from models.infrastructure.mysql.repositories.thanks import ThanksRepository
    ...
    def test_create_revision_delegates_to_revision_repository(self):
        ...
        with patch.object(
            MysqlClient, "revision_repository", new_callable=PropertyMock
        ) as mock_repo:
    ...
    def test_get_head_delegates_to_entity_repository(self):
        ...
        with patch.object(
            MysqlClient, "entity_repository", new_callable=PropertyMock
        ) as mock_repo:
    ...
    def test_get_redirect_target_delegates_to_redirect_repository(self):
        ...
        with patch.object(
            MysqlClient, "redirect_repository", new_callable=PropertyMock
        ) as mock_repo:
    ...
    def test_revert_redirect_calls_set_redirect_target_with_empty_string(self):
        ...
        with patch.object(MysqlClient, "set_redirect_target") as mock_set_redirect:
    ...
    def test_create_tables_creates_schema_repository(self):
        ...
        with patch(
            ...
            mock_schema_repo_class.assert_called_once_with(mysql_client=self.client)
