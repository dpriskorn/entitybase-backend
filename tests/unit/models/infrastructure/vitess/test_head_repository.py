...
class TestHeadRepository:
    def test_init(self) -> None:
        ...
        repo = HeadRepository(connection_manager, mock_id_resolver)

        assert repo.connection_manager == connection_manager
    ...
    def test_cas_update_with_status_success(self) -> None:
        ...
        result = repo.cas_update_with_status(conn, "Q42", 100, 200, True, False, False, False, False, False, False)
    ...
    def test_cas_update_with_status_entity_not_found(self) -> None:
        ...
        conn = MagicMock()
        result = repo.cas_update_with_status(conn, "Q42")
    ...
    def test_cas_update_with_status_cas_failed(self) -> None:
        ...
        result = repo.cas_update_with_status(conn, "Q42", 100, 200)
    ...
    def test_hard_delete_success(self) -> None:
        ...
        result = repo.hard_delete(conn, "Q42", 456)
    ...
    def test_hard_delete_entity_not_found(self) -> None:
        ...
        result = repo.hard_delete(conn=None, entity_id="Q42", head_revision_id=456)
    ...
    def test_soft_delete_success(self) -> None:
        ...
        result = repo.soft_delete(conn, "Q42")
    ...
    def test_soft_delete_entity_not_found(self) -> None:
        ...
        result = repo.soft_delete(conn=None, entity_id="Q42")
    ...
    def test_get_head_revision_success(self) -> None:
        ...
        repo = HeadRepository(connection_manager, mock_id_resolver)
        connection_manager.get_connection.return_value.__enter__.return_value = conn
        conn.cursor.return_value.__enter__.return_value = mock_cursor
    ...
    def test_get_head_revision_db_error(self) -> None:
        ...
        repo = HeadRepository(connection_manager, mock_id_resolver)
        connection_manager.get_connection.side_effect = Exception("DB error")
