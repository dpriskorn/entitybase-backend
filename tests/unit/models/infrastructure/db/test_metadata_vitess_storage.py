...
class TestMetadataVitessStorage:
    ...
    def test_store_metadata(self, mock_db_client):
        """Test storing metadata."""
        storage = MetadataVitessStorage(db_client=mock_db_client)
    ...
    def test_store_metadata_error(self, mock_db_client):
    ...
    def test_load_metadata_found(self, mock_db_client):
    ...
    def test_load_metadata_not_found(self, mock_db_client):
    ...
    def test_load_metadata_error(self, mock_db_client):
    ...
    def test_delete_metadata(self, mock_db_client):
    ...
    def test_delete_metadata_error(self, mock_db_client):
    ...
    def test_load_lemmas_batch(self, mock_db_client):
    ...
    def test_load_form_representations_batch(self, mock_db_client):
    ...
    def test_load_sense_glosses_batch(self, mock_db_client):
...
class TestSitelinkVitessStorage:
    ...
    def test_store_sitelink(self, mock_db_client):
        """Test storing sitelink."""
        storage = SitelinkVitessStorage(db_client=mock_db_client)
    ...
    def test_store_sitelink_error(self, mock_db_client):
    ...
    def test_load_sitelink_found(self, mock_db_client):
    ...
    def test_load_sitelink_not_found(self, mock_db_client):
    ...
    def test_load_sitelink_error(self, mock_db_client):
    ...
    def test_delete_sitelink(self, mock_db_client):
    ...
    def test_delete_sitelink_error(self, mock_db_client):
