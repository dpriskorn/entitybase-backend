...
Integration tests in tests/integration/models/infrastructure/vitess/test_db_client.py
...
class TestMysqlClient:
    ...
    def test_cursor_property_returns_cursor_context_manager(self):
        ...
        from models.infrastructure.db.connection import CursorContextManager
    ...
    def test_entity_repository_property(self):
        ...
        assert result.db_client == self.client
    ...
    def test_create_tables_creates_schema_repository(self):
        ...
        with patch(
            "models.infrastructure.db.repositories.schema.SchemaRepository"
            ...
            mock_schema_repo_class.assert_called_once_with(db_client=self.client)
