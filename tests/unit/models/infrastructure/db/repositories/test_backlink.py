...
from models.data.infrastructure.db.records.backlink_entry import BacklinkRecord
from models.infrastructure.db.repositories.backlink import BacklinkRepository
...
class TestBacklinkRepository:
    ...
    def test_insert_backlinks_empty(self):
        ...
        repo = BacklinkRepository(db_client=mock_db_client)
