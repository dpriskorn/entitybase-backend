...
class TestStatementVitessStorage:
    ...
    def test_store_statement(self, mock_db_client):
        """Test storing a statement."""
        storage = StatementVitessStorage(db_client=mock_db_client)
        statement_data = {
    ...
    def test_load_statement_not_found(self, mock_db_client):
        """Test loading a non-existent statement returns None."""
        storage = StatementVitessStorage(db_client=mock_db_client)
        mock_cursor = mock_db_client.cursor.__enter__.return_value
    ...
    def test_delete_statement(self, mock_db_client):
    ...
    def test_increment_ref_count(self, mock_db_client):
    ...
    def test_decrement_ref_count(self, mock_db_client):
    ...
    def test_exists(self, mock_db_client):
    ...
    def test_exists_not_found(self, mock_db_client):
...
class TestQualifierVitessStorage:
    ...
    def test_store_qualifier(self, mock_db_client):
        """Test storing a qualifier."""
        storage = QualifierVitessStorage(db_client=mock_db_client)
    ...
    def test_load_qualifier_not_found(self, mock_db_client):
...
class TestReferenceVitessStorage:
    ...
    def test_store_reference(self, mock_db_client):
        """Test storing a reference."""
        storage = ReferenceVitessStorage(db_client=mock_db_client)
    ...
    def test_load_reference_not_found(self, mock_db_client):
    ...
    def test_load_reference_success(self, mock_db_client):
    ...
    def test_load_references_batch(self, mock_db_client):
    ...
    def test_load_references_batch_with_none(self, mock_db_client):
    ...
    def test_delete_reference(self, mock_db_client):
...
class TestSnakVitessStorage:
    ...
    def test_store_snak(self, mock_db_client):
        """Test storing a snak."""
        storage = SnakVitessStorage(db_client=mock_db_client)
    ...
    def test_load_snak_not_found(self, mock_db_client):
