...
async def test_endorse_statement() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_withdraw_endorsement() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_get_statement_endorsements() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_get_statement_endorsement_stats() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_get_user_endorsements() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_get_user_endorsement_stats() -> None:
...
@pytest.mark.asyncio
@pytest.mark.integration
async def test_batch_endorsement_stats() -> None:
