...
async def test_get_entity_data_json() -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(f"/v1/entitybase/entities/{entity_id}.json")
...
async def test_get_entity_data_turtle() -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(f"/v1/entitybase/entities/{entity_id}.ttl")
        assert response.status_code == 200
...
async def test_get_entity_json_revision() -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(
            f"/v1/entitybase/entities/{entity_id}/revision/1/json"
        )
        assert response.status_code == 200
...
async def test_get_entity_revision_not_found() -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(
            f"/v1/entitybase/entities/{entity_id}/revision/999/json"
        )
...
async def test_get_entity_json_revision_not_found() -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(
            f"/v1/entitybase/entities/{entity_id}/revision/999/ttl"
        )
        assert response.status_code == 404
