...
def test_entity_retrieval_with_metadata_deduplication(db_client, s3_client):
...
def test_entity_retrieval_without_metadata(db_client, s3_client):
    """Test entity retrieval without metadata"""
    pass


def test_entity_history_pagination(db_client, s3_client) -> None:
    """Test entity history retrieval with pagination"""
    pass


def test_entity_revision_with_metadata(db_client, s3_client):
