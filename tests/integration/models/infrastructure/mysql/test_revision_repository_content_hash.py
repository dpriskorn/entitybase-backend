...
class TestRevisionRepositoryContentHash:
    ...
    def test_create_revision_stores_content_hash(self, db_conn):
        ...
        mysql_client.cursor = CursorContextManager(db_conn)
        mysql_client.id_resolver = MagicMock()
        mysql_client.id_resolver.resolve_id.return_value = 100

        repo = RevisionRepository(mysql_client=mysql_client)
    ...
    def test_get_content_hash(self, db_conn):
        ...
        mysql_client.cursor = CursorContextManager(db_conn)
        mysql_client.id_resolver = MagicMock()
        mysql_client.id_resolver.resolve_id.return_value = 200
    ...
    def test_create_with_cas_stores_content_hash(self, db_conn):
        ...
        mysql_client.cursor = CursorContextManager(db_conn)
        mysql_client.id_resolver = MagicMock()
        mysql_client.id_resolver.resolve_id.return_value = 300
