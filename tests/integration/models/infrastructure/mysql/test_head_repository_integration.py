...
@pytest.fixture
def repository(mysql_client):
    """Create HeadRepository instance with real Sql client."""
    return HeadRepository(mysql_client=mysql_client)


def test_get_head_revision_exists(repository, mysql_client):
    ...
    mysql_client.entity_repository.create_entity(entity_id)
    ...
    # Get internal ID
    internal_id = mysql_client.resolve_id(entity_id)
