...
class TestS3ClientRevisionReadWithContentHash:
    ...
    def test_read_revision_queries_database_first(self, s3_client, db_client):
    ...
    def test_read_revision_entity_not_found(self, s3_client, db_client):
    ...
    def test_read_revision_revision_not_found(self, s3_client, db_client):
    ...
    def test_read_revision_end_to_end(self, s3_client, db_client):
