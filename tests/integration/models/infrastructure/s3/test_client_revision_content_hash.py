...
class TestS3ClientRevisionReadWithContentHash:
    ...
    def test_read_revision_queries_database_first(self, s3_client, mysql_client):
        """Test that read_revision queries database first for content hash."""
        entity_id = "Q123"
        revision_id = 1

        mysql_client.register_entity(entity_id)
    ...
    def test_read_revision_entity_not_found(self, s3_client, mysql_client):
    ...
    def test_read_revision_revision_not_found(self, s3_client, mysql_client):
    ...
    def test_read_revision_end_to_end(self, s3_client, mysql_client):
