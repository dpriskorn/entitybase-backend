...
class TestRevisionRepositoryContentHash:
    ...
    def test_create_revision_stores_content_hash(self, db_conn):
        ...
        db_client = MagicMock()
        db_client.cursor = CursorContextManager(db_conn)
        db_client.id_resolver = MagicMock()
        db_client.id_resolver.resolve_id.return_value = 100

        repo = RevisionRepository(db_client=db_client)
    ...
    def test_get_content_hash(self, db_conn):
        ...
        db_client.cursor = CursorContextManager(db_conn)
        db_client.id_resolver = MagicMock()
        db_client.id_resolver.resolve_id.return_value = 200
    ...
    def test_create_with_cas_stores_content_hash(self, db_conn):
        ...
        db_client.cursor = CursorContextManager(db_conn)
        db_client.id_resolver = MagicMock()
        db_client.id_resolver.resolve_id.return_value = 300
