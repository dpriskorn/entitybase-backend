...
def test_item_labels_full_workflow(e2e_api_client, e2e_base_url) -> None:
    ...
    response = e2e_api_client.post(f"{base_url}/entities/items", json=create_data)
    ...
    response = e2e_api_client.delete(f"{base_url}/entities/items/{entity_id}/labels/en")
    assert response.status_code == 200
...
def test_item_descriptions_full_workflow(e2e_api_client, e2e_base_url) -> None:
    ...
    response = e2e_api_client.get(f"{base_url}/entities/items/{entity_id}/descriptions/en")
    assert response.status_code == 200
    ...
    response = e2e_api_client.delete(f"{base_url}/entities/items/{entity_id}/descriptions/en")
    assert response.status_code == 200
