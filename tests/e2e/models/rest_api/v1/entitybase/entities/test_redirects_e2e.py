...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_create_redirect(e2e_api_client, e2e_base_url, sample_item_data) -> None:
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_revert_redirect(e2e_api_client, e2e_base_url, sample_item_data) -> None:
