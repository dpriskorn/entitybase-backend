...
async def test_item_labels_full_workflow(api_prefix: str) -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(f"{api_prefix}/entities/items/{entity_id}/labels/en")
        assert response.status_code == 200
...
async def test_item_aliases_full_workflow(api_prefix: str) -> None:
    ...
    async with AsyncClient(
        ...
        response = await client.get(f"{api_prefix}/entities/items/{entity_id}/aliases/en")
        assert response.status_code == 200
        ...
        response = await client.put(
            f"{api_prefix}/entities/items/{entity_id}/aliases/en",
