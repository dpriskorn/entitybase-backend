...
@pytest.mark.asyncio
@pytest.mark.e2e
async def def test_item_labels_full_workflow(e2e_api_client, e2e_base_url) -> None:() -> None:
...
@pytest.mark.asyncio
@pytest.mark.e2e
async def def test_item_descriptions_full_workflow(e2e_api_client, e2e_base_url) -> None:() -> None:
    from models.rest_api.main import app
...
@pytest.mark.asyncio
@pytest.mark.e2e
async def def test_item_aliases_full_workflow(e2e_api_client, e2e_base_url) -> None:() -> None:
    from models.rest_api.main import app
