...
- [ ] Build RDF diff computation (using Jena/RDF4J) - see [RDF-DIFF-STRATEGY.md](../RDF-BUILDER/RDF-DIFF-STRATEGY.md)
...
- [SCHEMAS-EVENT-PRIMARY-SUMMARY.md](../../WIKIDATA/EXISTING-COMPONENTS/SCHEMAS-EVENT-PRIMARY-SUMMARY.md) - RDF change schema documentation
- [STREAMING-UPDATER-PRODUCER.md](../../WIKIDATA/EXISTING-COMPONENTS/STREAMING-UPDATER-PRODUCER.md) - Existing MediaWiki→RDF pipeline
- [STREAMING-UPDATER-CONSUMER.md](../../WIKIDATA/EXISTING-COMPONENTS/STREAMING-UPDATER-CONSUMER.md) - Existing RDF consumer for Blazegraph
