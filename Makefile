.PHONY: lint test test-fast coverage help ruff mypy radon vulture stop api api-no-cache api-vps docs docs-generate docs-build docs-serve check release ci
