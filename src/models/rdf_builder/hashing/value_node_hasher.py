...
class ValueNodeHasher:
    ...
    @staticmethod
    def hash_time_value(time_str: str, precision: int, timezone: int, calendar: str) -> str:
        ...
        parts = [
            f"t:{time_str}", str(precision), str(timezone), calendar
        ]
        return hashlib.md5(":".join(parts).encode()).hexdigest()
    
    @staticmethod
    def hash_quantity_value(value: str, unit: str, upper_bound: str | None = None, lower_bound: str | None = None) -> str:
        """Hash quantity value."""
