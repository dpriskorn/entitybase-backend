"""Mysql redirect repository for redirect operations."""
...
class RedirectRepository(Repository):
    ...
    def set_target(
        ...
        if redirects_to_entity_id:
            redirects_to_internal_id = self.mysql_client.id_resolver.resolve_id(
    ...
    def create(
        ...
        redirect_from_internal_id = self.mysql_client.id_resolver.resolve_id(
            redirect_from_entity_id
        )
        redirect_to_internal_id = self.mysql_client.id_resolver.resolve_id(
