...
from models.infrastructure.mysql.connection import (
...
class MysqlClient(Client):
    """Mysql database client for entity operations with connection pooling."""
    ...
    def model_post_init(self, context: Any) -> None:
        logger.debug("=== MysqlClient.model_post_init() START ===")
        logger.debug(
        ...
        logger.debug("=== MysqlClient.model_post_init() END ===")
        # self.create_tables()
