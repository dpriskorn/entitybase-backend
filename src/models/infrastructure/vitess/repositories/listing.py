    ...
    def list_locked(self, limit: int) -> list[EntityListing]:
        with self.vitess_client.cursor as cursor:
            ...
            for row in cursor.fetchall():
                ...
                result.append(
                    EntityListing(
                        entity_id=entity_id, entity_type=entity_type, reason="locked"
                    )
                )
            return result
    ...
    def list_archived(self, limit: int) -> list[EntityListing]:
        with self.vitess_client.cursor as cursor:
            ...
            for row in cursor.fetchall():
                ...
                result.append(
                    EntityListing(
                        entity_id=entity_id, entity_type=entity_type, reason="archived"
                    )
                )
            return result
    ...
    def list_dangling(self, limit: int) -> list[EntityListing]:
        with self.vitess_client.cursor as cursor:
            ...
            for row in cursor.fetchall():
                ...
                result.append(
                    EntityListing(
                        entity_id=entity_id, entity_type=entity_type, reason="dangling"
                    )
                )
            return result
    ...
    def _list_entities_by_edit_type(
        ...
        with self.vitess_client.cursor as cursor:
            ...
            for row in cursor.fetchall():
                ...
                result.append(
                    EntityListing(
                        entity_id=entity_id, entity_type=entity_type, reason=row[1]
                    )
                )
            return result
