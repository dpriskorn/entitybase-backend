...
@router.get("/entities/properties", response_model=OperationResult[EntityIdResult])
async def create_property(
    req: Request,
    headers: EditHeadersType,
) -> OperationResult[EntityIdResult]:
    """Create a new empty property entity."""
    logger.info("🔍 ENDPOINT: Received GET request to create property")
    ...
    try:
        ...
        request = EntityCreateRequest(type="property")
