...
async def update_sense_gloss(
    ...
    """Update sense gloss for a language."""
    logger.debug(f"Updating sense {sense_id} gloss for language {langcode}")
    ...
    logger.debug(f"Updated sense {sense_id} gloss in language {langcode}")
