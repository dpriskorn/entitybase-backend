...
class BacklinkService(Service):
    ...
    def extract_backlinks_from_entity(
        ...
        referencing_internal_id = self.mysql_client.id_resolver.resolve_id(entity_id)
        ...
        for property_id, statement_list in claims.items():
            for statement in statement_list:
                ...
                for referenced_entity_id, prop_id, rank in extracted:
                    referenced_internal_id = self.mysql_client.id_resolver.resolve_id(
    ...
    def extract_and_store_backlinks(
        ...
        result: OperationResult = (
            self.mysql_client.backlink_repository.insert_backlinks(backlinks)
        )
