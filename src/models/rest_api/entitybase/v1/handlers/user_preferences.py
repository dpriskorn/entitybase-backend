...
class UserPreferencesHandler(Handler):
    ...
    def get_preferences(self, user_id: int) -> UserPreferencesResponse:
        ...
        result = self.state.db_client.user_repository.get_user_preferences(user_id)  # type: ignore[union-attr]
    ...
    async def update_preferences(
        ...
        result = self.state.db_client.user_repository.update_user_preferences(  # type: ignore[union-attr]
            user_id=user_id,
