...
class ItemCreateHandler(EntityCreateHandler):
    ...
    def _resolve_entity_id(self, request: EntityCreateRequest) -> str:
        ...
        if entity_id:
            exists = self.state.db_client.id_resolver.entity_exists(entity_id)
    ...
    def _prepare_request_data(
        ...
        return PreparedRequestData.model_construct(**request_data.model_dump())  # type: ignore[no-any-return]
