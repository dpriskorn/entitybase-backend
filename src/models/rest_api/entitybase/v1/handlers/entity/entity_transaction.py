...
class EntityTransaction(BaseModel, ABC):
    ...
    def register_entity(self, entity_id: str) -> None:
        ...
        self.state.mysql_client.entity_repository.create_entity(entity_id)
    ...
    def _rollback_entity_registration(self) -> None:
        ...
        self.state.mysql_client.entity_repository.delete_entity(self.entity_id)
    ...
    def _rollback_revision(
        ...
        self.state.mysql_client.entity_repository.delete(entity_id, revision_id)
