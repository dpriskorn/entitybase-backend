...
class WatchlistEntryResponse(BaseModel):
    ...
    watched_properties: List[str] | None = Field(default=None, description="List of specific properties being watched, null for all")
...
class WatchlistResponse(BaseModel):
    ...
    watches: List[dict] = Field(description="List of watchlist entries with entity_id and properties")  # List of {"entity_id": str, "properties": List[str] | None}
