...
from models.rest_api.v1.entitybase.response.entity.entitybase import EntityResponse
...
from models.rest_api.v1.entitybase.response.entity import EntityState
