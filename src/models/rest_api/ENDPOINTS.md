...
| ✅ | POST | `/entitybase/v1/entities/import` | Import entities from Wikidata. |
...
| ❌ | POST | `/wikibase/v1/entities/items` | Create item - stub |
| ❌ | GET | `/wikibase/v1/entities/items/{item_id}` | Get item - stub |
...
| ❌ | POST | `/wikibase/v1/entities/properties` | Create property - stub |
| ❌ | GET | `/wikibase/v1/entities/properties/{property_id}` | Get property - stub |
