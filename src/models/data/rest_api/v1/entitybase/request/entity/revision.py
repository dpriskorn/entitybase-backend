...
class CreateRevisionRequest(BaseModel):
    ...
    request_data: PreparedRequestData = Field(
        ..., description="Full entity data for revision"
    )
    entity_type: EntityType = Field(
        ..., description="Type of entity (item, property, etc.)"
    )
    hash_result: StatementHashResult = Field(
        ..., description="Processed statement hashes"
    )
    ...
    is_semi_protected: bool = Field(
        default=False, description="Entity is semi-protected"
    )
    ...
    is_mass_edit_protected: bool = Field(
        default=False, description="Entity is mass edit protected"
    )
